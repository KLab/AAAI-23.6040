...
With this repository, you can reproduce the results based on the Stepmania dataset. (The results on the other datasets are excluded for copyrights reasons.)
In addition, you can produce a MIDI file for your own audio file, and by opening the MIDI file in DAW software and playing it, you can check the chart generated by _GenéLive!_.
